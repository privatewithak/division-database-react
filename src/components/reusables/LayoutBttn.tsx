...
export default function GlassButton({
  ...
  return (
    <button
      ...
      className={cx(
        "block px-8 py-2 bg-white/10 hover:bg-white/15 rounded-2xl my-auto min-w-25 flex-1" +
          "backdrop-blur-xl  " +
        ...
        MODE_STYLES[mode],
        isActive ? BASE_STYLES[mode] : "border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.2)] ",
        !disabled && "active: translate-y-0 active:scale-95",
        disabled &&
